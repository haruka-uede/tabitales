...
3. Once all three return, compile one combined report:
   ...
   - Your own one-line summary of what needs to change before this is ready to publish (or "ready as-is") — base this on load-bearing issues (see `CLAUDE.md` "Editorial priority: atmosphere over fact-precision"), not on minor-precision notes alone.
